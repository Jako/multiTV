		...
		switch ($this->display) {
			...
			case 'vertical': {
					...
					foreach ($this->fieldnames as $fieldname) {
						...
						$elements = (isset($this->fields[$fieldname]['elements'])) ? $this->fields[$fieldname]['elements'] : '';
						$default = (isset($this->fields[$fieldname]['default'])) ? $this->fields[$fieldname]['default'] : '';
						$tvcss .= '.multitv #[+tvid+]list li.element .' . $fieldname . ', .multitv #[+tvid+]heading .inline.' . $fieldname . ' { width: ' . $this->fields[$fieldname]['width'] . 'px; font-weight:'. $this->fields[$fieldname]['font-weight'] .' }' . "\r\n";
						switch ($type) {
							case 'thumb': {
